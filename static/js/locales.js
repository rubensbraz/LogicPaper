...
const TRANSLATIONS = {
    en: {
        ...
        navbar: {
            title_main: "Logic",
            title_sub: "Paper",
            subtitle: "Batch Processing Engine v1.4.0",
        ...
        alerts: {
            ...
            analysis_failed: "Data Analysis failed. Check Data Source format.",
            validation_modal: {
                title: "Validation Report",
                title_ok: "Compatibility Verified",
                title_warn: "Completed with Warnings",
                title_fail: "Validation Failed",
                desc_ok: "All templates match the Data Source schema.",
                desc_warn: "Validation passed, but some assets are missing.",
                desc_fail: "Some templates contain variables missing from your Data Source file.",
                status_missing: "Missing",
                status_warning: "Warning",
                missing_vars: "Missing Variables:",
                matched_vars: "variables matched.",
                missing_assets: "Missing Images:",
                matched_assets: "images matched.",
                no_assets_provided: "No Assets Zip provided.",
        ...
        logs: {
            ...
            task_started: "<span class='text-yellow-500'>Processing...</span>",
            row_processed: "<span class='text-green-500'>✓ {{percent}}%</span> | {{identifier}} ({{current}}/{{total}})",
            process_complete: "<span class='text-green-400 font-bold'>Batch Completed</span>",
            inputs_changed: "<span class='text-blue-500 font-bold tracking-widest block mt-2 mb-1'>Inputs Updated</span>",
            validation_success: "<span class='text-green-400'>Validation successful.</span>",
            sample_start: "<span class='text-purple-400 font-bold tracking-widest block mt-2 mb-1'>Generating Sample</span>",
            ...
            batch_init: "<span class='text-green-500 font-bold tracking-widest block mt-2 mb-1'>Starting Batch</span>",
            ...
            process_error: "<span class='text-red-400'>Process Error:</span> {{error}}"
        },
        footer: {
    ...
    pt: {
        ...
        navbar: {
            title_main: "Logic",
            title_sub: "Paper",
            subtitle: "Processamento em Lote v1.4.0",
            link_dashboard: "Dashboard",
            link_history: "Histórico",
            link_help: "Como Usar",
            link_api: "Docs API",
            badge_preview: "Modo Visualização",
        ...
        alerts: {
            ...
            analysis_failed: "Falha na Análise de Dados. Verifique o formato da Fonte de Dados.",
            validation_modal: {
                title: "Relatório de Validação",
                title_ok: "Compatibilidade Verificada",
                title_warn: "Concluído com Avisos",
                title_fail: "Falha na Validação",
                desc_ok: "Todos os modelos correspondem ao esquema da Fonte de Dados.",
                desc_warn: "Validação aprovada, mas algumas imagens estão ausentes.",
                desc_fail: "Alguns modelos contêm variáveis ausentes na Fonte de Dados.",
                status_missing: "Ausente",
                status_warning: "Aviso",
                missing_vars: "Variáveis Ausentes:",
                matched_vars: "variáveis correspondidas.",
                missing_assets: "Imagens Ausentes:",
                matched_assets: "imagens correspondidas.",
                no_assets_provided: "Nenhum arquivo ZIP fornecido.",
                matched: "variáveis correspondidas.",
        ...
        logs: {
            ...
            task_started: "<span class='text-yellow-500'>Processando...</span>",
            row_processed: "<span class='text-green-500'>✓ {{percent}}%</span> | {{identifier}} ({{current}}/{{total}})",
            process_complete: "<span class='text-green-400 font-bold'>Lote Finalizado</span>",
            inputs_changed: "<span class='text-blue-500 font-bold tracking-widest block mt-2 mb-1'>Entradas Atualizadas</span>",
            validation_success: "<span class='text-green-400'>Validação correta.</span>",
            sample_start: "<span class='text-purple-400 font-bold tracking-widest block mt-2 mb-1'>Gerando Amostra</span>",
            ...
            batch_init: "<span class='text-green-500 font-bold tracking-widest block mt-2 mb-1'>Iniciando Lote</span>",
            ...
            process_error: "<span class='text-red-400'>Erro no Processamento:</span> {{error}}"
        },
        footer: {
            copy: "LogicPaper © 2025-2026",
            repo: "Código Fonte",
